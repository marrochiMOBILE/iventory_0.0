...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-12 col-xl-10">
            ...
            <hr>
            <h5>Tambah data</h5>
            <form action="proses/pt_divisi.php" method="post">
            <div class="row">
                <div class="col-4">
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                        <a href='e_divisi.php?id=".$row['id_divisi']."' class='btn btn-warning'>Edit</a>
                        <a href='proses/ph_divisi.php?id=".$row['id_divisi']."' class='btn btn-danger'>Hapus</a>
                        </td>";
                        echo '</tr>';
                      }
                    } else {
